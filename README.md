...
npm run test:auth-boot    # 13 checks: the boot state machine, including a slow session restore
...
npm run test:token-renewal      # 12 checks: an expired token renews rather than logging you out
```
